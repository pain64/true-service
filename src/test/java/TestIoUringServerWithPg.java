...
public class TestIoUringServerWithPg {
    //@formatter:off
    //@formatter:on
    ...
    static void workerF(
        ...
        Connection cn, URing ring,
        short[] alloc, MemorySegment buffers, S state
    ) throws Throwable {
...
//                        }
                        ...
                        MemorySegment.copy(
                            ...
                            (long) BUFFER_SIZE * bufferNumberIn(connectionInfo), HELLO_RESPONSE.byteSize() - 1
                        );
    ...
    static void main() throws Throwable {
        ...
        var threads = new Thread[N_THREADS * N_IO];
                ...
                threads[i] = threadBuilder.start(() -> {
                    try {
                        workerF(
                            ...
                            connections[ii * N_IO + jj],
                            ring, alloc, buffers, state
                        );
                    } catch (Throwable e) {
                        throw new RuntimeException(e);
                    }
