...
public class ExpectParserEncoder implements ValueListHeaderParser<Expectation, Expect> {
    @Override
    ...
    @Override
    public void decode(ByteStream bs, Buffer bfr, ArrayList<Expectation> dest) {
