...
public class AcceptParserEncoder implements ValueListHeaderParser<MediaRange, Accept> {
    ...
    @Override
    public void decode(ByteStream bs, Buffer bfr, ArrayList<MediaRange> dest) {
